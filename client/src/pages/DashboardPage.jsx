    ...
    <div className="max-w-7xl mx-auto p-4 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          { title: "Code Doubts", icon: <FaCode size={32} />, link: "/doubts" },
        ].map((card) => (
          <div
            key={card.title}
            onClick={() => (window.location.href = card.link)}
            className="bg-white/80 backdrop-blur-md p-6 rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 cursor-pointer transition-all duration-300 flex flex-col items-center gap-4 text-center"
          >
